...
:--|:--|
<b> Lab | <b> 3D Printing
<b> Experiment|     <b> Simulation of Selective Laser Sintering (SLS) for Metals.
<h5> About the Experiment : </h5>

This experiment is about the simulation of Selective Laser Sintering process (Metals). In this experiment the user will understand the concept and working of laser sintering for metals and alloys.
